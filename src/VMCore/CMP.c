...
extern void __VAR__ cmp_asm(uint64 __VAR__ add1, uint64 __VAR__ add2, uint64 __PTR__ flag);

//
// CMP指令操作方法
// 返回执行状态标志
// 
byte __VAR__ CMP(struct instructionpackage __PTR__ instruct, CPU __PTR__ cpu, bool __PTR__ excuter_flag)
{
