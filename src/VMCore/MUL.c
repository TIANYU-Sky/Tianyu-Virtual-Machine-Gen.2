...
extern uint64 __VAR__ mul_asm(uint64 __VAR__ op1, uint64 __VAR__ op2, uint64 __PTR__ consult, uint64 __PTR__ remainder);

//
// MUL指令操作方法
// 返回执行状态标志
// 
byte __VAR__ MUL(struct instructionpackage __PTR__ instruct, CPU __PTR__ cpu, bool __PTR__ excuter_flag)
{
