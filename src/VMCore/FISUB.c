...
extern uint64 __VAR__ fisub_asm(double __PTR__ op1, uint64 __PTR__ op2, double __PTR__ result);

byte __VAR__ FISUB(struct instructionpackage __PTR__ instruct, CPU __PTR__ cpu, bool __PTR__ excuter_flag)
{
